...
ALLOWED_EXTENSIONS = {"pdf", "png", "jpg", "jpeg", "gif", "mp3"} # added mp3 because our project is a spotify clone and needs audio files
...
# to avoid overwriting files, we will create a unique filename each time
